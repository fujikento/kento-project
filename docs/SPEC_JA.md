...
| 項目 | 値 |
|---|---|
| リポジトリ名 | kento-project |
| アップストリーム | makeplane/plane |
...
git clone https://github.com/fujikento/kento-project.git ~/kento-project
cd ~/kento-project
...
- **ヘルスチェック URL**: `http://localhost:3030/` (要確認)
- **ログ確認**: `docker compose logs -f`
- **バックアップ**: (未定 — 要設計)

## 関連リンク

- アップストリーム GitHub: https://github.com/makeplane/plane
- フォーク先 GitHub: https://github.com/fujikento/kento-project
- ライセンス原文: https://github.com/makeplane/plane/blob/main/LICENSE
